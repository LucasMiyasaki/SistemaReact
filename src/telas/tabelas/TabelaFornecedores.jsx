        ...
        <Container>
            ...
            <Row>
                <Table striped bordered hover>
                    ...
                    <tbody>
                        {
                            listaFornecedores.map((forn, index) => (
                                <tr key={index}>
                                    <td>{forn.cod}</td>
                                    <td>{forn.nome}</td>
                                    <td>{forn.cidade}</td>
